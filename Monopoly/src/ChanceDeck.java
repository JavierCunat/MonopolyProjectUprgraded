//Inherits CardDeck to determine what chance card each player got and their movement then adds all parameters to create a new card pulled out of a deck and its contents
