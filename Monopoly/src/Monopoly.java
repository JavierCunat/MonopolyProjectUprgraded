...
//Main game function, simulates an entire game of Monopoly with bot, shows if any errors occur, and continues until only one player is not bankrupt or player that has most assests
//Bots have to have the same name to work
